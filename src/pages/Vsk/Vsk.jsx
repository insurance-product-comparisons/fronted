					...
					<div className={styles['left-column']}>
						...
						<Section>
							...
							<div className={styles['about-container']}>
								<Typography variant={'body2'}>
									Страховой Дом ВСК(САО «ВСК») осуществляет страховую
									деятельность с 11 февраля 1992 года и в настоящее время
									занимает ведущие позиции на рынке страховых услуг России.
								</Typography>
								<Typography variant={'body2'}>
									Высокий уровень работы компании четырежды отмечен
									благодарностью Президента России за большой вклад в развитие
									страхового дела (2002, 2007, 2017 и 2022).
								</Typography>
								<Typography variant={'body2'}>
						...
						<Section>
							...
							<div className={styles['term-container']}>
								<Typography variant={'body2'}>
									Страховыми событиями по ОСАГО являются случаи, когда
									вследствие эксплуатации транспорта был причинён имущественный
